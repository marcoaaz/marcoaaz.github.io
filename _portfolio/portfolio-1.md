...
See all the files to download at the bottom of the page.
...
With this software you can add new dimensions to your analysis since polarised optical microscopy can rapidly map for:
 ...
 - Texture: grains (properties), boundaries, contacts, neighbouring relationships, and rock fabric
...
For developers, you are welcome to use the GitHub source code that can be found at:
